        ...
        axios
            ...
            .then(({ data }) => {
                ...
                this.form = {
                    ...
                    nid: data.nid,
                    photo: data.photo,
                    phoneNumber: data.phone_number, // Map the backend column name to your field name
                    joiningDate: data.joining_date, // Map the backend column name to your field name
                    salary: data.salary,
                };
            })
            .catch();
